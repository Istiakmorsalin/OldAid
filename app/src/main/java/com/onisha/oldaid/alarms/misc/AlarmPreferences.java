...
public final class AlarmPreferences {
    ...
    public static int snoozeDuration(Context c) {
        return readPreference(c, com.onisha.oldaid.R.string.key_snooze_duration, 10);
    }

    // TODO: Consider renaming to hoursToNotifyInAdvance()
    public static int hoursBeforeUpcoming(Context c) {
        return readPreference(c, com.onisha.oldaid.R.string.key_notify_me_of_upcoming_alarms, 2);
    }

    public static int minutesToSilenceAfter(Context c) {
        return readPreference(c, com.onisha.oldaid.R.string.key_silence_after, 15);
    }

    public static int firstDayOfWeek(Context c) {
        return readPreference(c, com.onisha.oldaid.R.string.key_first_day_of_week, 0 /* Sunday */);
    }

...
import com.onisha.oldaid.alarms.data.AlarmCursor;
import com.onisha.oldaid.alarms.data.AlarmsListCursorLoader;
import com.onisha.oldaid.alarms.data.AsyncAlarmsTableUpdateHandler;
...
import com.onisha.oldaid.util.DelayedSnackbarHandler;
...
import static com.onisha.oldaid.util.FragmentTagUtils.makeTag;
...
public class AlarmsFragment extends RecyclerViewFragment<Alarm, BaseAlarmViewHolder, AlarmCursor,
    ...
    public static final String EXTRA_SCROLL_TO_ALARM_ID = "com.onisha.oldaid.alarms.extra.SCROLL_TO_ALARM_ID";
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mSnackbarAnchor = getActivity().findViewById(com.onisha.oldaid.R.id.main_content);
    ...
    protected int emptyMessage() {
        return com.onisha.oldaid.R.string.empty_alarms_container;
    }

    @Override
    protected int emptyIcon() {
        return com.onisha.oldaid.R.drawable.ic_alarm_96dp;
    }
    ...
    private static String makeTimePickerDialogTag() {
        return FragmentTagUtils.makeTag(AlarmsFragment.class, com.onisha.oldaid.R.id.fab);
    }
}

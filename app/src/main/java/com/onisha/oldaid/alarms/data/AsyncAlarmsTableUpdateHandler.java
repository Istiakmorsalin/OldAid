...
import com.onisha.oldaid.data.AsyncDatabaseTableUpdateHandler;
import com.onisha.oldaid.list.ScrollHandler;
import com.onisha.oldaid.data.AsyncDatabaseTableUpdateHandler;
...
public final class AsyncAlarmsTableUpdateHandler extends AsyncDatabaseTableUpdateHandler<Alarm, AlarmsTableManager> {
    ...
    protected void onPostAsyncDelete(Integer result, final Alarm alarm) {
        ...
        if (mSnackbarAnchor != null) {
            ...
            String message = getContext().getString(com.onisha.oldaid.R.string.snackbar_item_deleted,
                    getContext().getString(com.onisha.oldaid.R.string.alarm));
            Snackbar.make(mSnackbarAnchor, message, Snackbar.LENGTH_LONG)
                    .setAction(com.onisha.oldaid.R.string.snackbar_undo_item_deleted, new View.OnClickListener() {
                        @Override

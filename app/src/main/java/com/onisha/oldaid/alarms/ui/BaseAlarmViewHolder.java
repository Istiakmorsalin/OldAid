...
import com.onisha.oldaid.dialogs.TimePickerDialogController;
...
import com.onisha.oldaid.util.TimeTextUtils;
...
public abstract class BaseAlarmViewHolder extends BaseViewHolder<Alarm> {
    ...
    @Bind(com.onisha.oldaid.R.id.time) TextView mTime;
    @Bind(com.onisha.oldaid.R.id.on_off_switch) SwitchCompat mSwitch;
    @Bind(com.onisha.oldaid.R.id.label) TextView mLabel;
    @Bind(com.onisha.oldaid.R.id.dismiss) Button mDismissButton;
    ...
    public BaseAlarmViewHolder(ViewGroup parent, @LayoutRes int layoutRes,
        ...
        mDismissNowDrawable = ContextCompat.getDrawable(getContext(), com.onisha.oldaid.R.drawable.ic_dismiss_alarm_24dp);
        mCancelSnoozeDrawable = ContextCompat.getDrawable(getContext(), com.onisha.oldaid.R.drawable.ic_cancel_snooze);
...
//                        mAlarmController.cancelAlarm(oldAlarm, false);
    ...
    public void onBind(Alarm alarm) {
        ...
        mTimePickerDialogController.tryRestoreCallback(makeTag(com.onisha.oldaid.R.id.time));
        bindTime(alarm);
    ...
    @OnClick(com.onisha.oldaid.R.id.dismiss)
    void dismiss() {
    ...
    @OnTouch(com.onisha.oldaid.R.id.on_off_switch)
...
//    }
    ...
    @OnCheckedChanged(com.onisha.oldaid.R.id.on_off_switch)
    ...
    @OnClick(com.onisha.oldaid.R.id.time)
    void openTimePicker() {
        Alarm alarm = getAlarm();
        mTimePickerDialogController.show(alarm.hour(), alarm.minutes(), makeTag(com.onisha.oldaid.R.id.time));
    }
    ...
    private void bindTime(Alarm alarm) {
        ...
        TextView colorsSource = (TextView) itemView.findViewById(com.onisha.oldaid.R.id.colors_source);
...
//        int disabled = ContextCompat.getColor(getContext(), R.color.text_color_disabled_light);
    ...
    private void bindDismissButton(Alarm alarm) {
        ...
        String buttonText = snoozed
                ? getContext().getString(com.onisha.oldaid.R.string.title_snoozing_until, TimeFormatUtils.formatTime(getContext(), alarm.snoozingUntil()))
                : getContext().getString(com.onisha.oldaid.R.string.dismiss_now);

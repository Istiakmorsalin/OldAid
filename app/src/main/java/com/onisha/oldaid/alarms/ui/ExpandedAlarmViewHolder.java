...
package com.onisha.oldaid.alarms.ui;
...
import com.onisha.oldaid.alarms.misc.DaysOfWeek;
import com.onisha.oldaid.dialogs.RingtonePickerDialog;
import com.onisha.oldaid.dialogs.RingtonePickerDialogController;
import com.onisha.oldaid.list.OnListItemInteractionListener;
import com.onisha.oldaid.timepickers.Utils;
...
/**
 * Created by Onisha on 7/31/2016.
 */
public class ExpandedAlarmViewHolder extends BaseAlarmViewHolder {
    private static final String TAG = "ExpandedAlarmViewHolder";

    @Bind(com.onisha.oldaid.R.id.ok) Button mOk;
    @Bind(com.onisha.oldaid.R.id.delete) Button mDelete;
    @Bind(com.onisha.oldaid.R.id.ringtone) Button mRingtone;
    @Bind(com.onisha.oldaid.R.id.vibrate) TempCheckableImageButton mVibrate;
    @Bind({com.onisha.oldaid.R.id.day0, com.onisha.oldaid.R.id.day1, com.onisha.oldaid.R.id.day2, com.onisha.oldaid.R.id.day3, com.onisha.oldaid.R.id.day4, com.onisha.oldaid.R.id.day5, com.onisha.oldaid.R.id.day6})
    ToggleButton[] mDays;
    ...
    public ExpandedAlarmViewHolder(ViewGroup parent, final OnListItemInteractionListener<Alarm> listener,
        ...
        super(parent, com.onisha.oldaid.R.layout.item_expanded_alarm, listener, controller);
...
//                listener.onListItemUpdate(getAlarm(), getAdapterPosition());
        ...
        int[] dayToggleColors = {
                /*item 1*/Utils.getTextColorFromThemeAttr(getContext(), com.onisha.oldaid.R.attr.colorAccent),
                /*item 2*/Utils.getTextColorFromThemeAttr(getContext(), android.R.attr.textColorHint)
        };
        int[] vibrateColors = {
                /*item 1*/Utils.getTextColorFromThemeAttr(getContext(), com.onisha.oldaid.R.attr.colorAccent),
                /*item 2*/Utils.getTextColorFromThemeAttr(getContext(), com.onisha.oldaid.R.attr.themedIconTint)
        };
    ...
    public void onBind(Alarm alarm) {
        super.onBind(alarm);
        mRingtonePickerController.tryRestoreCallback(makeTag(com.onisha.oldaid.R.id.ringtone));
        bindDays(alarm);
        bindRingtone();
    ...
    @OnClick(com.onisha.oldaid.R.id.ok)
    void save() {
        // TODO
    }
...
//    }
    ...
    @OnClick(com.onisha.oldaid.R.id.ringtone)
...
//        ((Activity) getContext()).startActivityForResult(intent, AlarmsFragment.REQUEST_PICK_RINGTONE);
        ...
        mRingtonePickerController.show(getSelectedRingtoneUri(), makeTag(com.onisha.oldaid.R.id.ringtone));
    }

    @OnClick(com.onisha.oldaid.R.id.vibrate)
    ...
    @OnClick({ com.onisha.oldaid.R.id.day0, com.onisha.oldaid.R.id.day1, com.onisha.oldaid.R.id.day2, com.onisha.oldaid.R.id.day3, com.onisha.oldaid.R.id.day4, com.onisha.oldaid.R.id.day5, com.onisha.oldaid.R.id.day6 })
    ...
    private void bindRingtone() {
        int iconTint = Utils.getTextColorFromThemeAttr(getContext(), com.onisha.oldaid.R.attr.themedIconTint);

...
import com.onisha.oldaid.util.Preconditions;
...
import static com.onisha.oldaid.util.Preconditions.checkNotNull;
...
public class PendingAlarmScheduler extends BroadcastReceiver {
    ...
    public static final String EXTRA_ALARM_ID = "com.onisha.oldaid.alarms.background.PendingAlarmScheduler.extra.ALARM_ID";

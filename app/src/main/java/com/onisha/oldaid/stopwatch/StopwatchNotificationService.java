...
package com.onisha.oldaid.stopwatch;
...
import com.onisha.oldaid.chronometer.ChronometerDelegate;
import com.onisha.oldaid.chronometer.ChronometerNotificationService;
import com.onisha.oldaid.stopwatch.data.AsyncLapsTableUpdateHandler;
import com.onisha.oldaid.stopwatch.ui.StopwatchFragment;
...
public class StopwatchNotificationService extends ChronometerNotificationService {
    ...
    public static final String ACTION_ADD_LAP = "com.onisha.oldaid.stopwatch.action.ADD_LAP";
    public static final String ACTION_UPDATE_LAP_TITLE = "com.onisha.oldaid.stopwatch.action.UPDATE_LAP_TITLE";

    public static final String EXTRA_LAP_NUMBER = "com.onisha.oldaid.stopwatch.extra.LAP_NUMBER";
    ...
    public void onCreate() {
        super.onCreate();
        setContentTitle(getNoteId(), getString(com.onisha.oldaid.R.string.stopwatch));
    ...
    protected int getSmallIcon() {
        return com.onisha.oldaid.R.drawable.ic_stopwatch_24dp;
    }
    ...
    protected int getNoteId() {
        return com.onisha.oldaid.R.id.stopwatch_notification_service;
    }
...
//        stopSelf();
    ...
    protected void handleAction(@NonNull String action, Intent intent, int flags, int startId) {
        if (ACTION_ADD_LAP.equals(action)) {
            ...
            setContentTitle(getNoteId(), getString(com.onisha.oldaid.R.string.stopwatch_and_lap_number, lapNumber));
    ...
    private void syncNotificationWithStopwatchState(boolean running) {
        ...
        addAction(ACTION_ADD_LAP, com.onisha.oldaid.R.drawable.ic_add_lap_24dp, getString(com.onisha.oldaid.R.string.lap), getNoteId());

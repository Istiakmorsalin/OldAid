...
public class LapViewHolder extends BaseViewHolder<Lap> {
    ...
    @Bind(com.onisha.oldaid.R.id.lap_number) TextView mLapNumber;
    @Bind(com.onisha.oldaid.R.id.elapsed_time) ChronometerWithMillis mElapsedTime;
    @Bind(com.onisha.oldaid.R.id.total_time) TextView mTotalTime;

    public LapViewHolder(ViewGroup parent) {
        super(parent, com.onisha.oldaid.R.layout.item_lap, null);
    }

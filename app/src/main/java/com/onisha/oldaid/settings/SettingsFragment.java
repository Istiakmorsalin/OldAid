...
public class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.onisha.oldaid.R.xml.preferences);
        // Set ringtone summary
        setSummary(getPreferenceScreen().getSharedPreferences(), getString(com.onisha.oldaid.R.string.key_timer_ringtone));
        findPreference(getString(com.onisha.oldaid.R.string.key_alarm_volume))

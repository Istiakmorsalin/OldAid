...
package com.onisha.oldaid.settings;
...
/**
 * Created by Onisha on 6/6/2016.
 */
public class SettingsActivity extends BaseActivity {
    public static final String EXTRA_THEME_CHANGED = "com.onisha.oldaid.settings.extra.THEME_CHANGED";
    ...
    protected int layoutResId() {
        return com.onisha.oldaid.R.layout.activity_settings;
    }
    ...
    private String getSelectedTheme() {
        return mPrefs.getString(getString(com.onisha.oldaid.R.string.key_theme), "");
    }

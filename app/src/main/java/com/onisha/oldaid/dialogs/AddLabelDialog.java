...
import com.onisha.oldaid.util.KeyboardUtils;
import com.onisha.oldaid.R;

import static com.onisha.oldaid.util.KeyboardUtils.showKeyboard;

/**
 * Created by Onisha on 8/30/2016.
 *
...
public class AddLabelDialog extends BaseAlertDialogFragment {
    ...
    protected AlertDialog createFrom(AlertDialog.Builder builder) {
        ...
        mEditText.setId(com.onisha.oldaid.R.id.label);
        ...
        int spacingLeft = getResources().getDimensionPixelSize(com.onisha.oldaid.R.dimen.item_padding_start);
        int spacingRight = getResources().getDimensionPixelSize(com.onisha.oldaid.R.dimen.item_padding_end);

        builder.setTitle(com.onisha.oldaid.R.string.label)

...
package com.onisha.oldaid.ringtone;
...
import com.onisha.oldaid.ringtone.playback.RingtoneService;
import com.onisha.oldaid.util.LocalBroadcastHelper;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "com.onisha.oldaid.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "com.onisha.oldaid.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "com.onisha.oldaid.ringtone.action.SHOW_SILENCED";

    private static boolean sIsAlive = false;
    private T mRingingObject;

    @Bind(com.onisha.oldaid.R.id.title) TextView mHeaderTitle;
    @Bind(com.onisha.oldaid.R.id.auto_silenced_container) LinearLayout mAutoSilencedContainer;
    @Bind(com.onisha.oldaid.R.id.auto_silenced_text) TextView mAutoSilencedText;
    @Bind(com.onisha.oldaid.R.id.ok) Button mOkButton;
    @Bind(com.onisha.oldaid.R.id.buttons_container) LinearLayout mButtonsContainer;
    @Bind(com.onisha.oldaid.R.id.btn_text_left) TextView mLeftButton;
    @Bind(com.onisha.oldaid.R.id.btn_text_right) TextView mRightButton;
    ...
    protected int getAutoSilencedDrawable() {
        return com.onisha.oldaid.R.drawable.ic_error_outline_96dp;
    }
    ...
    @OnClick(com.onisha.oldaid.R.id.btn_left)
    protected abstract void onLeftButtonClick();

    @OnClick(com.onisha.oldaid.R.id.btn_right)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getHeaderContent((LinearLayout) findViewById(com.onisha.oldaid.R.id.header));
    ...
    protected final int layoutResId() {
        return com.onisha.oldaid.R.layout.activity_ringtone;
    }

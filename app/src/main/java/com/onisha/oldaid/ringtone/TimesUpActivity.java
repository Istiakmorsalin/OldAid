...
import com.onisha.oldaid.ringtone.playback.RingtoneService;
import com.onisha.oldaid.ringtone.playback.TimerRingtoneService;
import com.onisha.oldaid.timers.ui.CountdownChronometer;
import com.onisha.oldaid.timers.TimerController;
import com.onisha.oldaid.timers.TimerNotificationService;
...
public class TimesUpActivity extends RingtoneActivity<Timer> {
    ...
    protected void getHeaderContent(ViewGroup parent) {
        ...
        CountdownChronometer countdown = (CountdownChronometer) getLayoutInflater()
                .inflate(com.onisha.oldaid.R.layout.content_header_timesup_activity, parent, false);
    ...
    protected int getAutoSilencedText() {
        return com.onisha.oldaid.R.string.timer_auto_silenced_text;
    }

    @Override
    protected int getLeftButtonText() {
        return com.onisha.oldaid.R.string.add_one_minute;
    }

    @Override
    protected int getRightButtonText() {
        return com.onisha.oldaid.R.string.stop;
    }

    @Override
    protected int getLeftButtonDrawable() {
        return com.onisha.oldaid.R.drawable.ic_add_48dp;
    }

    @Override
    protected int getRightButtonDrawable() {
        return com.onisha.oldaid.R.drawable.ic_stop_48dp;
    }
    ...
    private void postExpiredTimerNote() {
        Notification note = new NotificationCompat.Builder(this)
                .setContentTitle(getString(com.onisha.oldaid.R.string.timer_expired))
                .setContentText(getRingingObject().label())
                .setSmallIcon(com.onisha.oldaid.R.drawable.ic_timer_24dp)
                .build();

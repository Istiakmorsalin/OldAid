...
public class TimerRingtoneService extends RingtoneService<Timer> {
    ...
    protected Uri getRingtoneUri() {
        String ringtone = PreferenceManager.getDefaultSharedPreferences(this).getString(
                getString(com.onisha.oldaid.R.string.key_timer_ringtone), Settings.System.ALARM_ALERT);
...
//        PendingIntent pi = PendingIntent.getActivity(this, 0, intent, 0);
        return new NotificationCompat.Builder(this)
                ...
                .setContentText(getString(com.onisha.oldaid.R.string.times_up))
...
//                .setOngoing(true) // foreground notes are ongoing by default
                .addAction(com.onisha.oldaid.R.drawable.ic_add_24dp,
                        getString(com.onisha.oldaid.R.string.add_one_minute),
                        getPendingIntent(ACTION_ADD_ONE_MINUTE, getRingingObject().getIntId()))
                .addAction(com.onisha.oldaid.R.drawable.ic_stop_24dp,
                        getString(com.onisha.oldaid.R.string.stop),
...
//                .setContentIntent(pi)
    ...
    protected boolean doesVibrate() {
        return PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
                getString(com.onisha.oldaid.R.string.key_timer_vibrate), false);
    }

    @Override
    protected int minutesToAutoSilence() {
        String value = PreferenceManager.getDefaultSharedPreferences(this).getString(
                getString(com.onisha.oldaid.R.string.key_timer_silence_after), "15");

...
import com.onisha.oldaid.ringtone.RingtoneActivity;
import com.onisha.oldaid.util.LocalBroadcastHelper;
import com.onisha.oldaid.util.ParcelableUtil;
...
public abstract class RingtoneService<T extends Parcelable> extends Service {
    ...
    // public okay
    public static final String ACTION_NOTIFY_MISSED = "com.onisha.oldaid.ringtone.action.NOTIFY_MISSED";
...
//    // that sends such a broadcast, is deprecated.
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (mAudioManager == null && mRingtone == null) {
            ...
            startForeground(com.onisha.oldaid.R.id.ringtone_service_notification, getForegroundNotification());

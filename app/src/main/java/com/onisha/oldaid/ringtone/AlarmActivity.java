...
public class AlarmActivity extends RingtoneActivity<Alarm> {
    ...
    protected void getHeaderContent(ViewGroup parent) {
        ...
        getLayoutInflater().inflate(com.onisha.oldaid.R.layout.content_header_alarm_activity, parent, true);
    }

    @Override
    protected int getAutoSilencedText() {
        return com.onisha.oldaid.R.string.alarm_auto_silenced_text;
    }

    @Override
    protected int getLeftButtonText() {
        return com.onisha.oldaid.R.string.snooze;
    }

    @Override
    protected int getRightButtonText() {
        return com.onisha.oldaid.R.string.dismiss;
    }

    @Override
    protected int getLeftButtonDrawable() {
        return com.onisha.oldaid.R.drawable.ic_snooze_48dp;
    }

    @Override
    protected int getRightButtonDrawable() {
        return com.onisha.oldaid.R.drawable.ic_dismiss_alarm_48dp;
    }
    ...
    private void postMissedAlarmNote() {
        ...
        Notification note = new NotificationCompat.Builder(this)
                .setContentTitle(getString(com.onisha.oldaid.R.string.missed_alarm))

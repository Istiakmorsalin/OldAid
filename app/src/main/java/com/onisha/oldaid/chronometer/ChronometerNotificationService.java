...
package com.onisha.oldaid.chronometer;
...
/**
 * Created by Onisha on 9/10/2016.
 */
public abstract class ChronometerNotificationService extends Service {
    public static final String ACTION_START_PAUSE = "com.onisha.oldaid.timers.action.START_PAUSE";
    public static final String ACTION_STOP = "com.onisha.oldaid.timers.action.STOP";

    public static final String EXTRA_ACTION_ID = "com.onisha.oldaid.extra.ID";
...
//    }
    ...
    protected final void addStartPauseAction(boolean running, long id) {
        addAction(ACTION_START_PAUSE,
                running ? com.onisha.oldaid.R.drawable.ic_pause_24dp : com.onisha.oldaid.R.drawable.ic_start_24dp,
                getString(running ? com.onisha.oldaid.R.string.pause : com.onisha.oldaid.R.string.resume),
                id);
    }
    ...
    protected final void addStopAction(long id) {
        addAction(ACTION_STOP, com.onisha.oldaid.R.drawable.ic_stop_24dp, getString(com.onisha.oldaid.R.string.stop), id);
    }

...
import com.onisha.oldaid.timers.data.TimersListCursorLoader;
import com.onisha.oldaid.util.ConfigurationUtils;
import com.onisha.oldaid.timers.EditTimerActivity;
import com.onisha.oldaid.timers.data.AsyncTimersTableUpdateHandler;
...
import static com.onisha.oldaid.util.ConfigurationUtils.getOrientation;
...
public class TimersFragment extends RecyclerViewFragment<Timer, TimerViewHolder, TimerCursor, TimersCursorAdapter> {
    ...
    public static final String EXTRA_SCROLL_TO_TIMER_ID = "com.onisha.oldaid.timers.extra.SCROLL_TO_TIMER_ID";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (ConfigurationUtils.getOrientation(r) == Configuration.ORIENTATION_LANDSCAPE) {
            RecyclerView list = ButterKnife.findById(view, com.onisha.oldaid.R.id.list);
            int cardViewMargin = r.getDimensionPixelSize(com.onisha.oldaid.R.dimen.cardview_margin);
    ...
    protected int emptyMessage() {
        return com.onisha.oldaid.R.string.empty_timers_container;
    }

    @Override
    protected int emptyIcon() {
        return com.onisha.oldaid.R.drawable.ic_timer_96dp;
    }

...
public class TimerNotificationService extends ChronometerNotificationService {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "com.onisha.oldaid.timers.action.CANCEL_NOTIFICATION";
    public static final String ACTION_ADD_ONE_MINUTE = "com.onisha.oldaid.timers.action.ADD_ONE_MINUTE";

    public static final String EXTRA_TIMER = "com.onisha.oldaid.timers.extra.TIMER";
    private static final String EXTRA_CANCEL_TIMER_ID = "com.onisha.oldaid.timers.extra.CANCEL_TIMER_ID";
    ...
    protected int getSmallIcon() {
        return com.onisha.oldaid.R.drawable.ic_timer_24dp;
    }
    ...
    protected void handleDefaultAction(Intent intent, int flags, int startId) {
        ...
        if (title.isEmpty()) {
            title = getString(com.onisha.oldaid.R.string.timer);
        }
    ...
    private void syncNotificationWithTimerState(long id, boolean running) {
        ...
        clearActions(id);
        addAction(ACTION_ADD_ONE_MINUTE, com.onisha.oldaid.R.drawable.ic_add_24dp, getString(com.onisha.oldaid.R.string.minute), id);
